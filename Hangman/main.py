...
for current_answer_index in answer_characters:
  if re.search("^[A-Z]$", current_answer_index):
...
while num_of_incorrect_guesses < 5 and False in answer_guesses:
  ...
  print(f"Number of incorrect guessed allowed remaining: {5 - num_of_incorrect_guesses}")
